...
enum class TouchControllerID {
    ...
    fun getControls(): List<ControlDef> {
         return when(this) {
             SNES -> listOf(
                 ControlDef.DPad("dpad", 0.15f, 0.65f),
                 ControlDef.Button("a", 0.9f, 0.65f, android.view.KeyEvent.KEYCODE_BUTTON_A, "A"),
                 ControlDef.Button("b", 0.82f, 0.73f, android.view.KeyEvent.KEYCODE_BUTTON_B, "B"),
                 ControlDef.Button("x", 0.82f, 0.57f, android.view.KeyEvent.KEYCODE_BUTTON_X, "X"),
                 ControlDef.Button("y", 0.74f, 0.65f, android.view.KeyEvent.KEYCODE_BUTTON_Y, "Y"),
                 ControlDef.Button("l", 0.15f, 0.35f, android.view.KeyEvent.KEYCODE_BUTTON_L1, "L"),
                 ControlDef.Button("r", 0.85f, 0.35f, android.view.KeyEvent.KEYCODE_BUTTON_R1, "R"),
                 ControlDef.Button("select", 0.4f, 0.8f, android.view.KeyEvent.KEYCODE_BUTTON_SELECT, label = null, icon = com.swordfish.touchinput.controller.R.drawable.button_select),
                 ControlDef.Button("start", 0.6f, 0.8f, android.view.KeyEvent.KEYCODE_BUTTON_START, label = null, icon = com.swordfish.touchinput.controller.R.drawable.button_start),
                 ControlDef.Button("menu", 0.5f, 0.1f, android.view.KeyEvent.KEYCODE_BUTTON_MODE, label = null, icon = com.swordfish.touchinput.controller.R.drawable.button_menu),
             )
             else -> emptyList()
         }
    }

    sealed class ControlDef(val id: String, val defaultX: Float, val defaultY: Float) {
        class Button(
            id: String, 
            defaultX: Float, 
            defaultY: Float, 
            ...
            val icon: Int? = null
        ) : ControlDef(id, defaultX, defaultY)
